...
it('shows courses overview',function (){
   //Arrange
    ...
    Course::factory()->create(['title'=>'Course C', 'description'=>'Description Course C',
        'released_at'=> Carbon::now()]);
    //Act
    get(route('home'))->assertSeeText(['Course A','Description Course A','Course B', 'Description Course B','Course C','Description Course C']);
...
it('shows only released courses by date',function (){
    //Arrange
    Course::factory()->create(['title'=>'Course A', 'released_at'=>Carbon::yesterday()]);
